...
public OnPlayerGiveDamage(playerid, damagedid, Float: amount, weaponid, bodypart)
{
    ...
    new str[50];
    format(str,sizeof(str)," Disparos: %d hit(s) %.0f daño", hit1[playerid], damage1[playerid]);
...
public OnPlayerTakeDamage(playerid, issuerid, Float: amount, weaponid)
{
        ...
        new str[50];
        format(str,sizeof(str),"Disparos recibidos: %d hit(s) %.0f daño", hit[playerid], damage2[playerid]);
