...
format(String2,sizeof(String2),"\nVehículo slot 1 ID:%d Precio slot 1: $ %d\nVehículo slot 1 ID: %d Precio slot 1: $ %d",GetPVarInt(playerid,"Model_1"),Preciodeusuario[0][playerid],Modelodeusuario[1][playerid],Preciodeusuario[1][playerid]);
