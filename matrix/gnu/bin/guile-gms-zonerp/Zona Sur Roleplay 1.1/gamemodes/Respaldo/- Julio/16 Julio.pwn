...
Mensaje(playerid,COLOR_BLANCO,String);
CargarGas[playerid] = strlen(inputtext);
...
if(IsPlayerConnected(playerid))
{
if(ViendoTV[playerid] == 0)
{
ViendoTV[playerid] = 1;
TogglePlayerControllable(playerid, 0);
SetPlayerCameraPos(playerid, -2787.288330, 261.436035, 24.106250);
SetPlayerCameraPos(playerid, -2787.288330, 261.436035, 24.106250);
SetPlayerCameraLookAt(playerid, -2787.288330, 261.436035, 24.106250);
return 1;
}
else
{
