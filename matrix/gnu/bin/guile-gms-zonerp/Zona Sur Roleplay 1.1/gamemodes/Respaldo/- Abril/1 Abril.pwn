...
Mensaje(playerid,COLOR_BLANCO,"--- Comandos: {009EFF}/Arrestar [ID] - Rango 5-6: /D [Departamento].");
Mensaje(playerid,COLOR_BLANCO,"---- Comandos: {009EFF}/Abrircarcel1 /Abrircarcel2 - /Cerrarcarcel1 /Cerrarcarcel2");
Mensaje(playerid,COLOR_BLANCO,"----- Comandos: {009EFF}/AbrirGarage - /CerrarGarage"); }
