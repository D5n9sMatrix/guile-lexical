...
if(PI[playerid][Faccion] == 1) return Mensaje(playerid,COLOR_BLANCO,"No eres de la policía.");
...
if(PI[playerid][Faccion] == 1 && PI[playerid][Rangof] == 6 || PI[playerid][Faccion] == 2 && PI[playerid][Rangof] == 6 || PI[playerid][Faccion] == 3 && PI[playerid][Rangof] == 6 || PI[playerid][Faccion] == 1 && PI[playerid][Rangof] == 6) {
new String[150],Nombre[MAX_PLAYER_NAME]; GetPlayerName(playerid,Nombre,sizeof(Nombre));
