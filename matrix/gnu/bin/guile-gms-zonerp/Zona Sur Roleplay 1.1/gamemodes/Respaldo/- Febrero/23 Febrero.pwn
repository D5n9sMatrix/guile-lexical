...
//echo									6-Transportador de mercadería.
...
/*
	...
	/* RENTA VEHÍCULOS*/
	RentaV[0] =	AddStaticVehicleEx(410,1561.8000500,-2308.8999000,13.3000000,90.0000000,255,255,360000); //Manana 17
	RentaV[1] =	AddStaticVehicleEx(410,1561.8000500,-2312.3000500,13.3000000,90.0000000,255,255,360000); //Manana18
	RentaV[2] =	AddStaticVehicleEx(410,1561.9000200,-2315.3999000,13.3000000,90.0000000,255,255,360000); //Manana19
	RentaV[3] =	AddStaticVehicleEx(410,1562.0000000,-2318.5000000,13.3000000,90.0000000,255,255,360000); //Manana20
	RentaV[4] =	AddStaticVehicleEx(410,1561.8000500,-2321.6999500,13.3000000,90.0000000,255,255,360000); //Manana21
	RentaV[5] =	AddStaticVehicleEx(410,1561.5999800,-2325.6001000,13.3000000,90.0000000,255,255,360000); //Manana22
	RentaV[6] =	AddStaticVehicleEx(410,1561.6999500,-2328.8000500,13.3000000,90.0000000,255,255,360000); //Manana23
	RentaV[7] =	AddStaticVehicleEx(410,1561.8000500,-2332.1999500,13.3000000,90.0000000,255,255,360000); //Manana24
	RentaV[8] =	AddStaticVehicleEx(410,1561.8000500,-2335.3000500,13.3000000,90.0000000,255,255,360000); //Manana25
	RentaV[9] =	AddStaticVehicleEx(410,1561.8000500,-2338.6001000,13.3000000,90.0000000,255,255,360000); //Manana26
...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
	...
	{
	    if(Bus2(vehicleid)){ if(PI[playerid][Trabajo] == 3) { Mensaje(playerid,COLOR_BLANCO,"Coloque /Recorrido , Para iniciar su recorrido.");  }  else Quitarcoche(playerid); }
		if(Rentavehiculos(vehicleid)) {
			if(Rentado[playerid] == 0 || RentadoV[vehicleid] == 0) {
				Dialog(playerid,RentarCocheD,DIALOG_STYLE_MSGBOX,"Contrato de renta.","\t ¿Deseas rentar éste vehículo?\n\n\tValor a pagar: $300\n El contrato es de 15 días.(15 Min IC).","Sí","No");
			}
