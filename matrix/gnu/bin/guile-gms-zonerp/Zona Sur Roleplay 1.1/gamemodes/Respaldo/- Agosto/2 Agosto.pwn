...
stock CrearTextPick(x,y,z,string[],string2[],pick) {
new String3[400];
CreatePickup(pick, 2, x,y,z,0);
...
*/
	...
	CrearTextPick(1173,-1323.2,15.3,"Hospital","/Entrar",Pickupentrada);
	CrearTextPick(-204.5,-1736.5,675.7,"Hospital Salida","/Salir",Pickupentrada);
	CrearTextPick(423.2,1597.3,481.2,"Centro de noticias LS","/Salir",Pickupentrada);
...
*/
	...
	//Taxista
	CreateDynamicObject(3627, 1802.93665, -1919.51501, 15.73039,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(3627, 1781.28040, -1919.34204, 16.19814,   0.00000, 0.00000, 0.72874);
	CreateDynamicObject(3749, 1812.61462, -1891.17627, 18.03754,   0.00000, 0.00000, 270.49121);
...
CMD:ircnn(playerid,params[]) {
SetPlayerPos(playerid,438.95999, 1596.67004, 482.64001);
return 1;
}
