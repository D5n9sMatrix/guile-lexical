...
4-Sistema de motor básico. -/prenderMotor -/ApagarMotor.
...
»	5-Piloto
»	6-Agricultor.
»	7-Agricultor de drogas.
»	8-Transportador de mercadería.
»	9-Taxista.
			____________________________________________________________________________________________________________________
...
new Pidiocolocacion[MAX_PLAYERS],PidioRuedas[MAX_PLAYERS],PidioModificacion[MAX_PLAYERS],PidioPintura[MAX_PLAYERS],PidioArreglo[MAX_PLAYERS];
new EMeca[16];
...
new String3[400];
format(String3,sizeof(String3),"{FFE600}[!]{FFFFFF}[%s].\n{00B3FF}%s",string,string2);
...
/*
	...
	{
	Tel2[i] = TextDrawCreate(509.000000, 261.333312, "LOADSC2:loadsc2");
	TextDrawLetterSize(Tel2[i], 0.000000, 0.000000);
	TextDrawTextSize(Tel2[i], 116.500000, 151.666687);
	TextDrawAlignment(Tel2[i], 1);
	TextDrawColor(Tel2[i], -1);
	TextDrawSetShadow(Tel2[i], 0);
	TextDrawSetOutline(Tel2[i], 0);
	TextDrawFont(Tel2[i], 4);
	TextDrawSetPreviewModel(Tel2[i], 416);
	TextDrawSetPreviewRot(Tel2[i], 0.000000, 0.000000, 90.000000, 1.000000);
	}
...
/*
	TextDrawSetSelectable(Tel15, true); TextDrawSetSelectable(Tel16, true); TextDrawSetSelectable(Tel12, true);*/
...
//	CreatePickup(1318, 2, 1481.52,-1748.4,15.3,0);//Ayuntamiento EXT AL INT
	...
	CrearTextPick(1487,-1768,15,"Ayuntamiento","/Entrar",Pickupentrada);
	CrearTextPick(1173,-1323,15,"Hospital","/Entrar",Pickupentrada);
	CrearTextPick(-204,-1736,675,"Hospital Salida","/Salir",Pickupentrada);
	CrearTextPick(423,1597,481,"Centro de noticias LS","/Salir",Pickupentrada);
	...
	CT("{FFE600}[!]{FFFFFF}Policia Federal\n{00B3FF}Ingreso {FFFFFF}/Entrar &#39;Y&#39;",COLOR_BLANCO,1554.8000500,-1675.6999500,16.8000000,10.0,0,0);
...
//CNN
	CreateDynamicObject(2933, 777.00000, 9522.00000, -1384.00000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(988, 780.75800, -1330.39844, 12.52778,   0.00000, 0.00000, 357.64682);
	CreateDynamicObject(988, 775.69495, -1330.20715, 12.52778,   0.00000, 0.00000, 358.14163);
	CreateDynamicObject(3928, 745.08313, -1372.91956, 24.81964,   0.00000, 0.00000, 358.45996);
	CreateDynamicObject(1557, 754.00000, 6870.00000, -1362.00000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(1557, 754.68488, -1365.69641, 13.14660,   0.00000, 0.00000, 91.11600);
	CreateDynamicObject(2933, 777.68927, -1384.68665, 14.54592,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(1557, 754.63965, -1362.73438, 13.14875,   0.00000, 0.00000, 270.26459);
	CreateDynamicObject(1566, 750.43481, -1359.58948, 14.43490,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(3627, 752.58496, -1339.53284, 14.87510,   0.00000, 0.00000, 90.15604);
...
// Hospital
	CreateDynamicObject(10932, 1195.39502, -1357.35583, 23.96080,   0.00000, 0.00000, 358.98721);
	CreateDynamicObject(987, 1149.91650, -1291.16736, 12.54420,   0.00000, 0.00000, 179.44960);
	CreateDynamicObject(3749, 1128.78125, -1292.75098, 18.36410,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject
	CreateDynamicObject(2423,362.45370483,-1620.03320312,38.35994339,0.00000000,0.00000000,266.00000000); //object(cj_ff_conter_1b) (1)
	CreateDynamicObject(2424,362.49316406,-1619.09582520,38.35994339,0.00000000,0.00000000,269.75000000); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,362.49691772,-1618.18261719,38.35994339,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,362.50024414,-1617.25329590,38.35994339,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,362.50619507,-1616.36181641,38.35994339,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,359.92224121,-1619.44775391,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,359.92715454,-1618.52026367,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,359.93826294,-1617.61437988,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,359.93295288,-1616.71081543,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,359.93930054,-1615.81909180,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,359.94360352,-1614.90527344,38.35994339,0.00000000,0.00000000,90.00000000); //object(cj_ff_conter_1) (1)
	CreateDynamicObject(2424,362.49017334,-1615.44372559,38.35994339,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,362.48937988,-1614.53210449,38.35994339,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(2424,362.48498535,-1614.06677246,38.36095810,0.00000000,0.00000000,269.74731445); //object(cj_ff_conter_1) (13)
	CreateDynamicObject(1649,362.11389160,-1617.07067871,41.48127747,0.00000000,0.00000000,270.00000000); //object(wglasssmash) (2)
	CreateDynamicObject(1649,362.21957397,-1616.76940918,41.45066452,0.00000000,0.00000000,90.00000000); //object(wglasssmash) (2)
	CreateDynamicObject(1649,359.94650269,-1616.90783691,41.63128662,0.00000000,0.00000000,270.00000000); //object(wglasssmash) (2)
	CreateDynamicObject(1649,360.41995239,-1617.44628906,41.55628204,0.00000000,0.00000000,90.00000000); //object(wglasssmash) (2)
	CreateDynamicObject(1514,358.72302246,-1620.13378906,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (1)
	CreateDynamicObject(1514,356.69561768,-1620.15356445,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (2)
	CreateDynamicObject(1514,363.42575073,-1620.01220703,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (3)
	CreateDynamicObject(1514,365.02276611,-1619.99121094,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (4)
	CreateDynamicObject(1514,367.47659302,-1619.99096680,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (5)
	CreateDynamicObject(1514,369.88327026,-1619.99694824,39.68087769,0.00000000,0.00000000,0.00000000); //object(dyn_ff_till) (6)
	CreateDynamicObject(2894,362.48062134,-1617.13806152,39.41551208,0.00000000,0.00000000,270.00000000); //object(kmb_rhymesbook) (1)
	CreateDynamicObject(2894,359.94094849,-1617.01159668,39.41551208,0.00000000,0.00000000,266.00000000); //object(kmb_rhymesbook) (2)
	CreateDynamicObject(18014,370.79492188,-1623.87670898,38.66714478,0.00000000,0.00000000,0.00000000); //object(int_rest_veg03) (1)
	CreateDynamicObject(18014,355.79492188,-1623.97412109,38.79214478,0.00000000,0.00000000,0.00000000); //object(int_rest_veg03) (2)
	CreateDynamicObject(1723,369.00073242,-1627.28222656,38.23494339,0.00000000,0.00000000,180.50000000); //object(mrk_seating1) (2)
	CreateDynamicObject(1722,367.14233398,-1624.87976074,38.23494339,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (1)
	CreateDynamicObject(1722,367.20251465,-1623.31921387,38.24272919,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (2)
	CreateDynamicObject(1722,368.92446899,-1623.28405762,38.24272919,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (3)
	CreateDynamicObject(1722,368.93414307,-1624.80615234,38.23494339,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (4)
	CreateDynamicObject(1722,368.02374268,-1624.88232422,38.23494339,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (6)
	CreateDynamicObject(1722,368.04193115,-1623.30627441,38.24272919,0.00000000,0.00000000,0.00000000); //object(off_chairnu) (7)
	CreateDynamicObject(2332,372.56933594,-1612.39526367,38.82283020,0.00000000,0.00000000,0.00000000); //object(kev_safe) (7)
	CreateDynamicObject(2191,368.71142578,-1611.83032227,38.35994339,0.00000000,0.00000000,0.00000000); //object(med_office2_cab) (1)
	CreateDynamicObject(2191,367.28759766,-1611.79187012,38.35994339,0.00000000,0.00000000,0.00000000); //object(med_office2_cab) (2)
	CreateDynamicObject(2332,372.56060791,-1612.38330078,39.75733185,0.00000000,0.00000000,0.00000000); //object(kev_safe) (11)
	CreateDynamicObject(2332,373.42822266,-1612.40124512,38.82283020,0.00000000,0.00000000,0.00000000); //object(kev_safe) (12)
	CreateDynamicObject(2332,373.43130493,-1612.40026855,39.75733185,0.00000000,0.00000000,0.00000000); //object(kev_safe) (13)
	CreateDynamicObject(2332,374.26223755,-1612.42651367,38.82283020,0.00000000,0.00000000,0.00000000); //object(kev_safe) (14)
	CreateDynamicObject(2332,374.27151489,-1612.38928223,39.75733185,0.00000000,0.00000000,0.00000000); //object(kev_safe) (15)
	CreateDynamicObject(2164,374.65350342,-1614.77246094,38.35994339,0.00000000,0.00000000,272.00000000); //object(med_office_unit_5) (1)
	CreateDynamicObject(2163,374.74511719,-1614.76196289,40.18505478,0.00000000,0.00000000,271.25000000); //object(med_office_unit_2) (1)
	CreateDynamicObject(2172,374.12646484,-1616.99536133,38.35994339,0.00000000,0.00000000,270.00000000); //object(med_office2_desk_1) (1)
	CreateDynamicObject(2172,372.33258057,-1619.12658691,38.35994339,0.00000000,0.00000000,179.50000000); //object(med_office2_desk_1) (2)
	CreateDynamicObject(2591,370.86053467,-1617.92541504,41.06183243,0.00000000,0.00000000,0.00000000); //object(ab_partition1) (1)
	CreateDynamicObject(1723,360.24722290,-1625.32104492,38.23494339,0.00000000,0.00000000,180.49987793); //object(mrk_seating1) (3)
	CreateDynamicObject(1723,360.18902588,-1622.83447266,38.24272537,0.00000000,0.00000000,180.49987793); //object(mrk_seating1) (4)
	CreateDynamicObject(2754,357.46179199,-1628.11206055,39.26208878,0.00000000,0.00000000,270.00000000); //object(otb_machine) (1)
	CreateDynamicObject(2754,358.93551636,-1628.11169434,39.26208878,0.00000000,0.00000000,270.00000000); //object(otb_machine) (2)
	CreateDynamicObject(1714,358.70773315,-1618.61901855,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (1)
	CreateDynamicObject(1714,356.69265747,-1618.57629395,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (2)
	CreateDynamicObject(1714,363.33715820,-1618.37048340,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (3)
	CreateDynamicObject(1714,365.08654785,-1618.39965820,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (4)
	CreateDynamicObject(1714,367.55551147,-1618.36437988,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (5)
	CreateDynamicObject(1714,370.39260864,-1618.33447266,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (6)
	CreateDynamicObject(1714,371.54501343,-1617.68969727,38.35994339,0.00000000,0.00000000,0.00000000); //object(kb_swivelchair1) (7)
	CreateDynamicObject(1714,372.87371826,-1617.18090820,38.35994339,0.00000000,0.00000000,87.00000000); //object(kb_swivelchair1) (8)
	CreateDynamicObject(2191,358.78936768,-1612.26879883,38.35994339,0.00000000,0.00000000,0.00000000); //object(med_office2_cab) (3)
	CreateDynamicObject(2191,357.39761353,-1612.25305176,38.35994339,0.00000000,0.00000000,0.00000000); //object(med_office2_cab) (4)
	CreateDynamicObject(630,356.42324829,-1613.24584961,39.38510132,0.00000000,0.00000000,0.00000000); //object(veg_palmkb8) (1)
	CreateDynamicObject(630,370.20205688,-1613.33154297,39.38510132,0.00000000,0.00000000,0.00000000); //object(veg_palmkb8) (2)
	CreateDynamicObject(630,370.17959595,-1626.58642578,39.26010132,0.00000000,0.00000000,0.00000000); //object(veg_palmkb8) (3)
	CreateDynamicObject(630,356.24795532,-1627.35778809,39.26010132,0.00000000,0.00000000,0.00000000); //object(veg_palmkb8) (4)
...
public OnPlayerEnterVehicle(playerid, vehicleid, ispassenger)
{
    ...
    if(Motorencendido[playerid] == 0) { Mensaje(playerid,Gris,"Atención:{FFFFFF} El motor del coche está apagado.Coloca{555555} /PrenderMotor"); }
...
Pidiocolocacion[IdTun[playerid]] += Mecanico[PCambio];
PidioRuedas[IdTun[playerid]] = Mecanico[PRuedas];
...
PidioModificacion[IdTun[playerid]] = Mecanico[PModificaciones];
Pidiocolocacion[IdTun[playerid]] += Mecanico[PCambio];
ColocarP[IdTun[playerid]] = modelid;
Mensaje(IdTun[playerid],COLOR_BLANCO,"/Colocarlopedido ((Recuerda hacer el rol!))");
IdTun[IdTun[playerid]] = false;
...
{/*
	...
	if (Presionado (KEY_YES)){
	TextDrawHideForPlayer(playerid,Tel1); TextDrawHideForPlayer(playerid,Tel2); TextDrawHideForPlayer(playerid,Tel3); TextDrawHideForPlayer(playerid,Tel4);
	TextDrawHideForPlayer(playerid,Tel5); TextDrawHideForPlayer(playerid,Tel6); TextDrawHideForPlayer(playerid,Tel7[playerid]); TextDrawHideForPlayer(playerid,Tel8);
	TextDrawHideForPlayer(playerid,Tel9); TextDrawHideForPlayer(playerid,Tel10); TextDrawHideForPlayer(playerid,Tel11); TextDrawHideForPlayer(playerid,Tel12);
	TextDrawHideForPlayer(playerid,Tel13); TextDrawHideForPlayer(playerid,Tel14); TextDrawHideForPlayer(playerid,Tel15); TextDrawHideForPlayer(playerid,Tel16);
	TextDrawHideForPlayer(playerid,Tel17); TextDrawHideForPlayer(playerid,Tel18);
...
{
if(dialogid == D_MecanicoFactura) { if(response) {

GivePlayerMoney(IdTun[playerid],pagar[playerid]);
Pidiocolocacion[playerid] = 0,PidioRuedas[playerid] = 0,PidioModificacion[playerid] = 0,PidioPintura[playerid] = 0,PidioArreglo[playerid] = 0;
Pidiocolocacion[IdTun[playerid]] = 0,PidioRuedas[IdTun[playerid]] = 0,PidioModificacion[IdTun[playerid]] = 0,PidioPintura[IdTun[playerid]] = 0,PidioArreglo[IdTun[playerid]] = 0;
IdTun[IdTun[playerid]] = false;
IdTun[playerid] = false;
}}
...
if(listitem == 1) {
new Coche = GetPlayerVehicleID(playerid);
PidioArreglo[IdTun[playerid]] = Mecanico[PArreglar];
Pidiocolocacion[IdTun[playerid]] += Mecanico[PCambio];
...
PidioPintura[IdTun[playerid]] += Mecanico[PPintura];
IdTun[IdTun[playerid]] = false;
IdTun[playerid] = false;
}
}
...
if(listitem == 1) { Mensaje(playerid,COLOR_BLANCO,"- Comandos: {009EFF}/PrenderMotor /ApagarMotor /ControlC /estacionar"); }
...
new String[600] = "{FFFFFF}\t\t ZONA SUR  {006FFF}ROLEPLAY{FFFFFF} [V1.0]\n{FF1212}»{FFFFFF} Programador principal: Max_Contreras - {FF1212}»{FFFFFF}Programador secundario: Nazareno_Quintana\n{FF1212}»{FFFFFF} Mapping:Ezequiel_Numerosky - Julian Cardillo - Max_Contreras.";
...
new String[200];
format(String,sizeof(String),"-{FFFFFF}Comida Cantidad[{008EEC}%d{FFFFFF}]\n-Bebida(s) Cantidad[{008EEC}%d{FFFFFF}]\n- Cocaina [{008EEC}%d{FFFFFF}]\n- Porro [{008EEC}%d{FFFFFF}]\n- Pizza [{008EEC}%d{FFFFFF}]",PI[playerid][CComida],PI[playerid][CBebida],PI[playerid][TCocaina],PI[playerid][TPorro],PI[playerid][TPizza]);
...
CMD:fddfssdfsdf(playerid,params[]) {
...
if(Demanda == 1) {
Dialog(playerid,DemandaC1,DIALOG_STYLE_LIST,"Orden de comida.","- Pizza $20\t\t\t(-20% {008EEC}Apetito{FFFFFF})\n- Bebida $10\t\t\t(-20% {008EEC}Sed{FFFFFF})\n- Combo - 2xPizza + 2xBebida $56","Comprar","Salir");
}
else if(Demanda == 2) {
Dialog(playerid,DemandaC2,DIALOG_STYLE_LIST,"Oferta del día. - Orden de comida.","- Pizza $18\t\t\t(-20% {008EEC}Apetito{FFFFFF})\n- Bebida $9\t\t\t(-20% {008EEC}Sed{FFFFFF})\n- Combo - 2xPizza + 2xBebida $50","Comprar","Salir");
}
return 1;
}
...
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Felicidades , empieza a {FF6600}trabajar.");
}
else if(PlayerToPoint(playerid,5.0,1110.6,-1795.5,16.5)) { //Bus URBANO NUM7
PI[playerid][Trabajo] = 7;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Felicidades , empieza a{FF6600} trabajar.");
}
else if(PlayerToPoint(playerid,5.0,1775.4,-1749.5,14.3)) { //Bus Larga distancia NUM3
PI[playerid][Trabajo] = 3;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Felicidades , empieza a{FF6600} trabajar.");
}
else if(PlayerToPoint(playerid,5.0,1753.8,-1903,13.5)) { //Taxista NUM6
PI[playerid][Trabajo] = 6;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Felicidades , empieza a{FF6600} trabajar.");
}
else if(PlayerToPoint(playerid,5.0,1753.8,-1903,13.5)) { //Transportista de gasolina NUM9
...
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Dejaste de trabajar en la empresa {FF6600}Transportista.");
}
}
else if(PI[playerid][Trabajo] == 7) {
if(PlayerToPoint(playerid,5.0,1110.6,-1795.5,16.5)) { //Bus URBANO NUM7
PI[playerid][Trabajo] = 0;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Dejaste de trabajar en la empresa {FF6600}Bus Urbano.");
}
}
if(PI[playerid][Trabajo] == 3) {
if(PlayerToPoint(playerid,5.0,1775.4,-1749.5,14.3)) { //Bus Larga distancia NUM3
PI[playerid][Trabajo] = 0;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Dejaste de trabajar en la empresa {FF6600}Bus larga distancia.");
}
}
if(PI[playerid][Trabajo] == 6) {
if(PlayerToPoint(playerid,5.0,1753.8,-1903,13.5)) { //Taxista NUM6
PI[playerid][Trabajo] = 0;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Dejaste de trabajar en la empresa {FF6600}Taxista.");
}
}
if(PI[playerid][Trabajo] == 9) {
if(PlayerToPoint(playerid,5.0,1753.8,-1903,13.5)) { //Transportista de gasolina NUM9
PI[playerid][Trabajo] = 0;
Mensaje(playerid,COLOR_BLANCO,"{0099FF}[Info]:{FFFFFF} Dejaste de trabajar en la empresa {FF6600}Transportista de gasolina.");
}
}
return 1;
}
...
CMD:irtransportistagas(playerid,params[]) {
SetPlayerPos(playerid,23.7998000,-249.2998000,7.0000000);
return 1;
}
CMD:irhospitalinterior(playerid,params[]) {
SetPlayerPos(playerid,-207.39999, -1739.69995, 676.50000);
return 1;
}
...
CMD:darfactura(playerid,params[]) {

if(PI[playerid][Faccion] == 6) {
if(!sscanf(params,"d",params[0])) {
new String[100],String2[100],String3[100],String4[100],String5[100],String6[600];
format(String,sizeof(String),"{009EFF}-{FFFFFF} Colocación: {29DF00}$%d.\n",Pidiocolocacion[playerid]);
format(String2,sizeof(String2),"{009EFF}-{FFFFFF} Arreglos {FF2600}[Carrocería+Motor]{FFFFFF}: {29DF00}$%d.\n",PidioArreglo[playerid]);
format(String3,sizeof(String3),"{009EFF}-{FFFFFF} Pintura[s] {FF2600}[Quitado de pintura+Colocación de pintura]{FFFFFF}:{29DF00} $%d.\n",PidioPintura[playerid]);
format(String4,sizeof(String4),"\n{009EFF}-{FFFFFF} Modificaciones {FF2600}[Componentes]{FFFFFF}: {29DF00}$%d.\n",PidioModificacion[playerid]);
format(String5,sizeof(String5),"{009EFF}-{FFFFFF} Ruedas: {29DF00}$%d.\n\n\t\t{FF2600}»{FFFFFF}Total a pagar: {29DF00}$%d",PidioRuedas[playerid],Pidiocolocacion[playerid]+PidioRuedas[playerid]+PidioModificacion[playerid]+PidioPintura[playerid]+PidioArreglo[playerid]);
strcat(String6,String); strcat(String6,String2); strcat(String6,String3); strcat(String6,String4); strcat(String6,String5);
Dialog(params[0],D_MecanicoFactura,DIALOG_STYLE_MSGBOX,"[Facturación]",String6,"Pagar","");
IdTun[params[0]] = playerid;

pagar[params[0]] = Pidiocolocacion[playerid]+PidioRuedas[playerid]+PidioModificacion[playerid]+PidioPintura[playerid]+PidioArreglo[playerid];
//Pidiocolocacion[MAX_PLAYERS],PidioRuedas[MAX_PLAYERS],PidioModificacion[MAX_PLAYERS],PidioPintura[MAX_PLA YERS],PidioArreglo[MAX_PLAYERS];
} else Mensaje(playerid,COLOR_BLANCO,"/DarFactura [ID].");
} else Mensaje(playerid,COLOR_BLANCO,"No eres mecánico.");
...
return 1;
										...
										Aquí finaliza el código del gamemode.
																																																						*/
		  //Colores ZSRP {0099FF} // Naranja {FF6600}
