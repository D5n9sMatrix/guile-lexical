...
new EntroPropiedadID[MAX_PLAYERS];
...
public OnPlayerTakeDamage(playerid, issuerid, Float: amount, weaponid)
{
    ...
    {
        switch(weaponid) {
        case 22: { SetPlayerHealth(playerid,-30); }
        case 28: { SetPlayerHealth(playerid,-60); }
        case 29: { SetPlayerHealth(playerid,-35); }
        case 30: { SetPlayerHealth(playerid,-40); }
        case 31: { SetPlayerHealth(playerid,-40); }
        case 32: { SetPlayerHealth(playerid,-30); }
        case 36: { SetPlayerHealth(playerid,-80); }
        }
    }
    return 1;
}
