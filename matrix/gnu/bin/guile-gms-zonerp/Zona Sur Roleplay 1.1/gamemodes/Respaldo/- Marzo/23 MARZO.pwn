...
*/
    ...
    CT("{00B3FF}/Banco {00E304}$500",COLOR_BLANCO,2528.7,-1801.7,712.8,5.0,0,0);
...
CMD:a(playerid,params[]){
    ...
    switch(PI[playerid][Staff]){
        case 1: RangoA = "Moderador";
        case 2: RangoA = "Moderado JR";
        case 3: RangoA = "Administrador";
        case 4: RangoA = "Admin General";
        case 5: RangoA = "Admin Líder";
		case 6: RangoA = "Desarrollador";
         //ETC...
    }
...
command(sentarse, playerid, params[])
    ...
    command(sexo, playerid, params[]){
	    new sexstyle;
	    if(!IsPlayerInAnyVehicle(playerid)) return SendClientMessage(playerid, COLOR_GREY, "No puedes hacer esto ahora !");
        if(sscanf(params, "d", sexstyle)) return SendClientMessage(playerid, COLOR_WHITE, "USA: /fuck [1-8]");
 		switch(sexstyle){
