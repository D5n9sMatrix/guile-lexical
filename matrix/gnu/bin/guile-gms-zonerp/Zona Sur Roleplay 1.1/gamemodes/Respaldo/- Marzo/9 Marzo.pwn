...
Mensaje(playerid,COLOR_BLANCO,String);} }
Mensaje(playerid,COLOR_BLANCO,"! Ahora sube a un bus y utilizá {FF0000}/iniciarruta{FFFFFF}. (No se puede cancelar).");
}
return 1;
}


CMD:iniciarruta(playerid,params[]) {
if(PI[playerid][Trabajo] == 7) {
if(TieneLinea[playerid] == 0) {
if(TieneLinea[playerid] == 115) {
LineaA[playerid] = 1;
Checkpoint(playerid,12,15,10,5.0);
Mensaje(playerid,COLOR_BLANCO,"{FF0000}> {FFFFFF}Primera parada. - LINEA {0080FF}115.");
}
...
AddVehicleComponent(Coche, ColocarP[playerid]); // Nitro
ColocarP[playerid] = 0;
