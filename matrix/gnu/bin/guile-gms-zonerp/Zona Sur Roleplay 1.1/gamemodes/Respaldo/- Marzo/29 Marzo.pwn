...
public OnPlayerTakeDamage(playerid, issuerid, Float: amount, weaponid)
{
    ...
    {
        switch(weaponid) {
        case 22: { SetPlayerHealth(playerid,-10); }
        case 28: { SetPlayerHealth(playerid,-10); }
        case 29: { SetPlayerHealth(playerid,-10); }
        case 30: { SetPlayerHealth(playerid,-10); }
        case 31: { SetPlayerHealth(playerid,-10); }
        case 32: { SetPlayerHealth(playerid,-10); }
        case 36: { SetPlayerHealth(playerid,-10); }
        }
    }
    return 1;
}
...
if(PlayerToPoint(playerid,2.0,207.3,-100.8,1005.2)) {
Eligiolaropa[playerid] = 0;
Mensaje(playerid,COLOR_BLANCO,"Has devuelto la ropa.");
}
return 1;
}
