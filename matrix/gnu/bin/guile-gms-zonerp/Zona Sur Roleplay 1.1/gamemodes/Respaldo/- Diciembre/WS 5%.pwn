  ...
  /Ayuda
					____________________________________________________________________________________________________________________
-Sistema adminstrativo con 8 comandos.
...
public OnPlayerEnterCheckpoint(playerid)
{
	...
	/* Trabajo: -Basurero-*/
	else if(TrabajoBasurero[playerid] == 1) {
...
if(dialogid == Dgenero) {
if(response) {
if(listitem == 0) { PI[playerid][Genero] = 0;  SpawnPlayer(playerid); AD(playerid); } //Masculino
if(listitem == 1) { PI[playerid][Genero] = 0;  SpawnPlayer(playerid); AD(playerid); } } }//Femenino
if(dialogid == DAyuda) {
if(response) {
if(listitem == 0) { Mensaje(playerid,COLOR_BLANCO,"Comandos: {555555}/Créditos /Version /Reglas "); }
...
format(String,sizeof(String),"Usuario:",Gris," %s,",COLOR_BLANCO," Genero:,",Gris," %s ",COLOR_BLANCO,"Trabajo:",Gris," %s",User,Generos,Trabajos);
...
format(String,sizeof(String),"[Chat Admin] %s %s: %s",User,RangoA,params);
...
new CMDAdminD[150];
strcat(CMDAdminD,"\t\t\t{555555}Comandos administrativos.\n\t{FFFFFF}/Kick - /Ban - /A - /daradmin - /Ao - /fly -/darnivel");
...
Dialog(playerid,DAyuda,DIALOG_STYLE_LIST,"Dialogo de ayuda.","*General\n*Coche\n*Banco","Elegir","Salir");
return 1;
}
...
Dialog(playerid,DReglas,DIALOG_STYLE_MSGBOX,"Reglas del servidor","Reglas...","Listo","");
return 1;
}
...
/* FALTAN COORDENADAS*/
Dialog(playerid,DBanco,DIALOG_STYLE_LIST,"Banco.","-Depositar\n-Sacar\n-Estado","Elegir","Salir");
return 1;
}
...
new String[290] = "\t\t- {006FFF}Programador:{FFFFFF}ScriptNoob (Max_Contreras).\n\t\t- {006FFF}Mapping:{FFFFFF}ScriptNoob (Max_Contreras)\n\n\n \n\n\n{555555}Gamemode creado desde 0 Sin ninguna base.\n Todos los derechos reservados.";
