...
16-Sistema de paga-(PAYDAY).
17-Sistema de inicio de sección administrativa. PASSWORD:StaffInicio
...
PI[playerid][Subnivel] = dini_Int(Archivo,"Exp");
...
dini_IntSet(Archivo,"Exp",PI[playerid][Subnivel]);
return 1;
}
...
public OnGameModeInit()
{
	...
	//SAPD VEHICLES
	LSpdcar[0] = AddStaticVehicleEx(596,1600.5072000,-1684.0070000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[1] = AddStaticVehicleEx(596,1600.5341000,-1687.8213000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
    LSpdcar[2] = AddStaticVehicleEx(596,1600.5402000,-1692.1780000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[3] = AddStaticVehicleEx(596,1600.5605000,-1696.2428000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[4] = AddStaticVehicleEx(596,1600.5952000,-1700.2393000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[5] = AddStaticVehicleEx(596,1600.5952000,-1704.6896000,5.5948000,90.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[6] = AddStaticVehicleEx(596,1595.4028000,-1709.5269000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[7] = AddStaticVehicleEx(596,1591.3287000,-1709.5557000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[8] = AddStaticVehicleEx(596,1587.1460000,-1709.5544000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[9] = AddStaticVehicleEx(596,1583.1172000,-1709.5703000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[10] = AddStaticVehicleEx(596,1578.0376000,-1709.5813000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[11] = AddStaticVehicleEx(596,1574.3641000,-1709.5851000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[12] = AddStaticVehicleEx(596,1570.1042000,-1709.5717000,5.5880000,0.0000000,-1,-1,15); //Police Car (LSPD)
	LSpdcar[13] = AddStaticVehicleEx(523,1567.4780000,-1708.7915000,5.3446000,0.0000000,-1,-1,15); //HPV1000
	LSpdcar[14] = AddStaticVehicleEx(523,1564.7528000,-1708.9294000,5.3446000,0.0000000,-1,-1,15); //HPV1000
	LSpdcar[15] = AddStaticVehicleEx(523,1566.0632000,-1708.8516000,5.3446000,0.0000000,-1,-1,15); //HPV1000
	LSpdcar[16] = AddStaticVehicleEx(523,1563.4158000,-1709.0302000,5.3446000,0.0000000,-1,-1,15); //HPV1000
	LSpdcar[17] = AddStaticVehicleEx(523,1562.0979000,-1709.0254000,5.3446000,0.0000000,-1,-1,15); //HPV1000
	LSpdcar[18] = AddStaticVehicleEx(522,1539.0850000,-1645.2111000,5.3831000,0.0000000,-1,-1,15); //NRG-500
	LSpdcar[19] = AddStaticVehicleEx(522,1530.9551000,-1645.1963000,5.3831000,0.0000000,-1,-1,15); //NRG-500
	LSpdcar[20] = AddStaticVehicleEx(522,1535.1143000,-1645.2400000,5.3831000,0.0000000,-1,-1,15); //NRG-500
	LSpdcar[21] = AddStaticVehicleEx(522,1526.5288000,-1645.3751000,5.3831000,0.0000000,-1,-1,15); //NRG-500
	LSpdcar[22] = AddStaticVehicleEx(497,1572.6125000,-1645.1311000,28.4936000,0.0000000,-1,-1,15); //Police Maverick
	LSpdcar[23] = AddStaticVehicleEx(497,1560.0370000,-1645.1428000,28.4936000,0.0000000,-1,-1,15); //Police Maverick
	LSpdcar[24] = AddStaticVehicleEx(427,1556.6611000,-1613.6708000,13.3865000,0.0000000,-1,-1,15); //Enforcer
	LSpdcar[25] = AddStaticVehicleEx(427,1561.9891000,-1613.7703000,13.3865000,0.0000000,-1,-1,15); //Enforcer
	LSpdcar[26] = AddStaticVehicleEx(427,1566.5634000,-1613.7905000,13.3865000,0.0000000,-1,-1,15); //Enforcer
	LSpdcar[27] = AddStaticVehicleEx(427,1571.0386000,-1613.8285000,13.3865000,0.0000000,-1,-1,15); //Enforcer
	...
	//LSPDExte
	CreateDynamicObject(3749, 1544.24426, -1627.60095, 18.12475,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(982, 1552.46399, -1602.49463, 16.60210,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(982, 1578.10864, -1602.48267, 16.60210,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(983, 1594.11304, -1602.47083, 16.58840,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(983, 1600.55310, -1602.47424, 16.58840,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(983, 1604.67456, -1602.46155, 16.58840,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(982, 1607.91748, -1615.23462, 16.58720,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1607.92981, -1631.26196, 16.58820,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1607.91638, -1634.45764, 16.58820,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(1215, 1607.95276, -1637.95483, 16.42417,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1604.61096, -1637.93250, 16.58450,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(983, 1539.66040, -1605.74255, 16.61191,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1539.65662, -1612.12610, 16.61191,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1539.66309, -1614.52612, 16.61191,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(983, 1542.88000, -1617.72949, 16.60983,   0.00000, 0.00000, 90.00000);
	CreateDynamicObject(983, 1546.04053, -1617.74060, 16.60983,   0.00000, 0.00000, 90.00000);
	//LSPD
	Portonlspd = CreateObject(980, 1545.12891, -1627.62354, 15.16136,0.00000000,0.00000000,90.00000000);
	//Text hosp
	Hospital = CreateObject(5708, 1134.24719, -1338.05835, 23.15630, 0.00000, 0.00000, 0.00000);
	SetObjectMaterial(Hospital, 6, 6134, "venice_law", "stonewall_la", 0);
	SetObjectMaterial(Hospital, 10, 6134, "venice_law", "stonewall_la", 0);
    SetObjectMaterial(Hospital, 7, 19366, "all_walls", "mp_diner_woodwall", 0);
	//Text lspd
	lspdtext = CreateObject(3976, 1571.80713, -1675.77222, 35.55185,   0.00000, 0.00000, 0.00000);
	SetObjectMaterial(lspdtext, 8, 5040, "shopliquor_las", "lasjmliq1", 0);
    SetObjectMaterial(lspdtext, 6, 5040, "shopliquor_las", "lasjmliq1", 0);
    SetObjectMaterial(lspdtext, 12, 5040, "shopliquor_las", "lasjmliq1", 0);
    SetObjectMaterial(lspdtext, 13, 5040, "shopliquor_las", "lasjmliq1", 0);
	return 1;
}
...
public OnPlayerRequestClass(playerid, classid)
{
	...
	/* Registro y inicio.*/
	if(fexist(Archivo)) { Dialog(playerid, Inicio,DIALOG_STYLE_INPUT,"{FFFFFF}Bienvenido a Trabajos Simulador","{65BAFF}Zona Sur {FFFFFF}Roleplay\n\n Ingresá tu contraseña y Inícia","Iniciar","Salir");
...
{
	//Map
	RemoveBuildingForPlayer(playerid, 5708, 1134.24719, -1338.05835, 23.15630, 0.25);
    RemoveBuildingForPlayer(playerid, 3976, 1571.80713, -1675.77222, 35.55185, 0.25);
	//
 	AFK[playerid] = 0;
 	Admininiciado[playerid] = 0;
...
if(dialogid == D_STAFFINICIO) { if(response) {
if(strcmp(inputtext ,"StaffInicio")) return Mensaje(playerid,COLOR_BLANCO,"Error en la contraseña.");
Mensaje(playerid,COLOR_BLANCO,"Iniciaste sección en equipo de staff. Ahora podrás usar los comandos.");
Admininiciado[playerid] = 1;
}
}
return 1;
}
...
} else Mensaje(playerid,COLOR_BLANCO,"Inicia sección de staff primero.");
return 1;
}
...
command(aplspd, playerid, params[])
{
if(PI[playerid][Faccion] == 1) return Mensaje(playerid,COLOR_BLANCO,"No eres de LSPD puta");
MoveObject(Portonlspd,1545.1289, -1627.6235, 9.4912,3.0);
Mensaje(playerid, Gris, "Guardia: {FFFFFF}Reja abierta oficial.");
return 1;
}

command(cplspd, playerid, params[])
{
MoveObject(Portonlspd,1545.12891, -1627.62354, 15.16136,3.0);
Mensaje(playerid, Gris, "Guardia: {FFFFFF}Reja cerrada oficial, suerte al patrullar.");
return 1;
}

command(hos, playerid, params[])
{
SetPlayerPos(playerid, 1134.2500, -1338.0781, 23.1563);
return 1;
}

CMD:afk(playerid,params[]) {
SetPlayerPos(playerid, 638.8848, 1683.5554, 6.9886);
SendClientMessage(playerid, COLOR_BLANCO, "Entraste en modo afk, para salir usa /salirafk");
SetPlayerHealth(playerid, 8000);
SetPlayerArmour(playerid, 9000);
TogglePlayerControllable(playerid, 0);
new name[MAX_PLAYER_NAME+1], string[128];
GetPlayerName(playerid, name, sizeof(name));

format(string, sizeof(string), "EL usuario {0C8EF8}%s {FF0000}Está AFK", name);
...
format(string, sizeof(string), "EL usuario {0C8EF8}%s {FF0000}salió del AFK", name);
SendClientMessageToAll(0xFFFFFF00, string);
return 1;
}
...
/*	new option[50];
	...
	{
		SendClientMessage(playerid,COLOR_YELLOW,"Colocá: /Casa [Nombre]");
	...
	{
		if(IsPlayerInRangeOfPoint(playerid,2.0,444.646911,508.239044,1001.419494)) return ShowPlayerDialog(playerid,D_SALIRC,DIALOG_STYLE_MSGBOX,"House Options","Do you want to leave this house?","Yes","No");
		if(IsPlayerInRangeOfPoint(playerid,2.0,2527.654052,-1679.388305,1015.498596)) return ShowPlayerDialog(playerid,D_SALIRC,DIALOG_STYLE_MSGBOX,"House Options","Do you want to leave this house?","Yes","No");
		if(IsPlayerInRangeOfPoint(playerid,2.0,2807.619873,-1171.899902,1025.570312)) return ShowPlayerDialog(playerid,D_SALIRC,DIALOG_STYLE_MSGBOX,"House Options","Do you want to leave this house?","Yes","No");
		if(IsPlayerInRangeOfPoint(playerid,2.0,1527.229980,-11.574499,1002.097106)) return ShowPlayerDialog(playerid,D_SALIRC,DIALOG_STYLE_MSGBOX,"House Options","Do you want to leave this house?","Yes","No");
		if(IsPlayerInRangeOfPoint(playerid,2.0,2496.049804,-1695.238159,1014.742187)) return ShowPlayerDialog(playerid,D_SALIRC,DIALOG_STYLE_MSGBOX,"House Options","Do you want to leave this house?","Yes","No");
	}*/
	
CMD:iniciarstaff(playerid,params[]) {
Dialog(playerid,D_STAFFINICIO,DIALOG_STYLE_INPUT,"Iniciar a la administración.","Coloque la contraseña del equipo administrativo.\n Si no eres del staff, se te saldra el juego.","Aceptar","Salir");
return 1;
}
