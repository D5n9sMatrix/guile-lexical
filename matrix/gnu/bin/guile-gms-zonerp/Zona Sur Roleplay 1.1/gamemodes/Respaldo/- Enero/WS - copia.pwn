...
{
new mensaje[128];
if(!isnull(params))  return SendClientMessage(playerid, Gris, "Uso: /me [ACCIÓN RP]");
{
...
GetPlayerName(playerid,Nombre,sizeof(Nombre));
format(string1,sizeof(string1),"[Facción]%s [Rango:%d]:%s",Nombre,PI[playerid][Rangof],params);
...
new string1[120],Nombre[MAX_PLAYER_NAME];
GetPlayerName(playerid,Nombre,sizeof(Nombre));
format(string1,sizeof(string1),"[Radio]%s :%s",Nombre,params);
