...
1- Basurero.
2- Piloto.
3- Bus Larga distancia.
4- Cosechador de drogas.
5- Transportista.
6- Taxista.
7- Bus Urbano.
8- Ladrón.
9- Transportista de gas.
			____________________________________________________________________________________________________________________
...
public OnPlayerEnterVehicle(playerid, vehicleid, ispassenger)
{
	...
	else if(CocheTaxi(vehicleid)) { if(ispassenger) { if(Pidiotaxi[playerid] == 1) { if(EstaenTaxi[playerid] == 0) {TimerTaxi[playerid] = SetTimerEx("FichaT", 15000, true, "i", playerid); EstaenTaxi[playerid] = 1; }} else Quitarcoche(playerid);  } }
...
else if(PlayerToPoint(playerid,5.0,106.157966,-222.529983,1.578125)){//Transportista garca de cosa con la que EEUU se hace millonario.(gasolina)
