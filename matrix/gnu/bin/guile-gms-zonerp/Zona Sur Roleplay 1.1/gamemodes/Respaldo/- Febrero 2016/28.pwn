...
CMD:canasta(playerid,params[]) {
	new String[300],String2[30],Numero;
	if(Canasta[playerid][0] != 0) {
	for(new i=0;i<10;i++) {
	if(Canasta[playerid][i] == 1) { format(String2,sizeof(String2),"(%d) - Pepsi.",Numero); i++; strcat(String,String2); }
	else if(Canasta[playerid][i] == 2) { format(String2,sizeof(String2),"(%d) - Coca-Cola.",Numero); i++; strcat(String,String2); }
	else if(Canasta[playerid][i] == 3) { format(String2,sizeof(String2),"(%d) - Pan Jamón y queso..",Numero); i++; strcat(String,String2); }
	else if(Canasta[playerid][i] == 4) { format(String2,sizeof(String2),"(%d) - Pan Jamón y queso..",Numero); i++; strcat(String,String2); }
	}
