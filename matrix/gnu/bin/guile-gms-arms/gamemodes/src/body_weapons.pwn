...
stock UpdateWeaponsInBody(playerid) 
{
	...
	for(new i = 0; i != sizeof PLAYER_WEAPONS[]; i ++) 
	{
		...
		switch(weaponId) 
		{
			...
			case 47: if(!IsPlayerShieldInUse(playerid)) SetPlayerAttachedObject(playerid, 9, 18637, 6, -0.359999, 0.042999, -0.114999, 102.600006, -2.499998, 17.300006, 1.000000, 1.000000, 1.000000);
		}
	}
}